...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, LogOut, MessageSquareQuote, Search, Settings2, Zap } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'quick-analysis', labelKey: 'layout.nav.quickAnalysis', to: '/quick-analysis', icon: Zap },
